...
import { isAutoCountQuery, isDimension, isDisabledAutoCountQuery, isEnabledAutoCountQuery, isFieldQuery, isMeasure, isValueQuery, scaleType, } from '../query/encoding';
import { ExpandedType } from '../query/expandedtype';
import { contains, every, some } from '../util';
import { isWildcard } from '../wildcard';
import { AbstractConstraintModel } from './base';
...
// For testing
export const SPEC_CONSTRAINT_INDEX = SPEC_CONSTRAINTS.reduce((m, c) => {
    m[c.name()] = c;
    return m;
}, {});
 ...
 */
export function checkSpec(prop, wildcard, specM, schema, opt) {
